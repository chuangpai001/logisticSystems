					...
					<form action="" method="post" id="addForm">
						<div class="add_mod" style="margin-top:20px;">
							...
							<div style="margin-top:10px;">
								...
								任务类型： <select style="width:180px;">
									<option>收款</option>
									<option>送货收款</option>
									<option>送货</option>
									<option>退货</option>
									<option>换货</option>
								</select> 配送员： <select style="width:180px;">
									<option>123</option>
									<option>456</option>
							...
							<div>
								<a style="margin-top:20px;margin-left:350px;"
									href="printDeliveryOrderResult.jsp"><type =button
										id="add" class="btn_confirm">确定</a>
							</div>
						</div>
					</form>
				</div>
