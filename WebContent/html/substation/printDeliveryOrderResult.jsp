							...
							<div class="table_mod" style="width:450px;">
								<div>
									...
									<table class="table">
										...
										<tbody class="th_list">
											<tr class="odd">
												<td>送货日期：2017-07-15</td>
												<td>完成时间： <input type="text" size="12"
													style="height:20px;" class="ltxt"/>
												</td>
												<td>是否要发票：<input type="radio"></td>
											</tr>
											<tr class="odd">
											...
											<tr class="odd">
												<td>备注： <input style="width:250px;height:50px;" class="ltxt"></td>
												<td>客户反馈：<input style="width:250px;height:50px;" class="ltxt"></td>
												<td>客户签名： <input type="text" size="12"
													style="height:20px;" class="ltxt"/>
												</td>
											</tr>
										</tbody>
									...
									<div>
										<a style="padding-top:10px;margin-left:350px;"
											href="printResult.jsp"><type =button id="add"
												class="btn_confirm">打印</a>
									</div>
								</div>
							</div>
						</div>
