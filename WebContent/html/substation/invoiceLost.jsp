										...
										<ul class="ng-scope">
											<li class="">
												<div class="ng-isolate-scope">
													<a href="findWorkOrder.invoiceBack.jsp" class="ng-scope">
				...
				<div class="viewFramework-product-body">
					<form action="" method="post" id="addForm">
						<div class="add_mod" style="margin-top:20px;">
							...
							<div style="margin-top:10px;width:990px;">
								<table class="table">
									发票丢失填写
									<tbody class="th_list">
										<tr class="odd">
											<td>发票号码： <input type="text" style="height:20px;" class="ltxt"/></td>
											<td>任务单号码： <input type="text" style="height:20px;" class="ltxt"/></td>
											<td>丢失人姓名： <input type="text" style="height:20px;" class="ltxt"/></td>
										</tr>
									</tbody>
								</table>
								<a style="padding-top:20px;margin-left:360px;"
									href="invoiceLost.jsp"><type =button id="add"
