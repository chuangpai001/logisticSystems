			...
			<div class="aliyun-console-topbar ng-scope ng-isolate-scope">
				<div class="topbar-wrap topbar-clearfix">
					<div class="topbar-head topbar-left">
						<a href="" target="_blank" class="topbar-logo topbar-left">
						<img src="../../pageResource/logo4.png"></a>
					</div>
					...
					<form action="" method="post" id="addForm">
						<div class="add_mod" style="margin-top:20px;">
							...
							<div style="margin-top:10px;">
								&nbsp;查询条件：<br>&nbsp;请选择时间： <input onClick="laydate()" class="ltxt">
								任务类型： <select style="width:150px;">
									<option>送货</option>
									<option>退货</option>
									<option>换货</option>
								</select> 投递员：<input type="text"  class="ltxt"> <input type="submit" value="查询">
							</div>
									...
									<table class="table">
										...
										<tbody class="th_list">
											<tr class="odd">
												...
												<td>2017-07-15</td>
												<td>送货</td>
												<td><a href="returnReceiptEntryResult.jsp"
													style="color:#000000">录入</a></td>
											</tr>
											<tr class="odd">
												<td height="30px">2</td>
												<td>李四</td>
												...
												<td>2017-07-15</td>
												<td>退货</td>
												<td><a href="returnReceiptEntryResult2.jsp"
													style="color:#000000">录入</a></td>
											</tr>
											<tr class="odd">
												<td height="30px">3</td>
												...
												<td>2017-07-15</td>
												<td>换货</td>
												<td><a href="returnReceiptEntryResult3.jsp"
													style="color:#000000">录入</a></td>
											</tr>
										</tbody>
									</table>
