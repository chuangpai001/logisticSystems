								...
								<div>
									<table class="table">
										...
										<tbody class="th_list">
											...
											<tr class="odd">
												<td>备注： <textarea cols="40"></textarea>
												</td>
												<td>客户满意度： <textarea cols="40"></textarea>
												</td>
												<td style="border:0px;"></td>
												<td style="border:0px;"></td>
												<td style="border:0px;"></td>
									...
									<div>
										<input type="button" value="打印此单"
											onClick="window.location.href='printDeliveryOrder.html'">
									</div>
								</div>
							</div>
						</div>
