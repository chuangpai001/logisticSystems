						...
						<div class="add_mod" style="margin-top:20px;">
							...
							<div class="table_mod" style="width:450px;">
								<div>
									...
									<table class="table">
										...
										<tbody class="th_list">
											<tr class="odd">
												...
												<td>商品数量：1</td>
												<td>换货地址：辽宁省大连市</td>
												<td>客户满意度：<input type="text"
													style="width:150px;height:50px;"  class="ltxt"></td>
									...
									<div>
										<a style="padding-top:20px;margin-left:300px;"
											href="returnReceiptEntry.jsp"><type =button id="add"
												class="btn_confirm">确认</a>
									</div>
								</div>
							</div>
						</div>
