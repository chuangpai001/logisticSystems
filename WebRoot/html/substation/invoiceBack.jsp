				...
				<div class="viewFramework-product-body">
					<form action="" method="post" id="addForm">
						<div class="add_mod" style="margin-top:20px;">
							...
							<div>
								<ul id="nav">
									<li><a href="substationBillManage.html">发票领用</a></li>
									<li><a href="invoiceBack.html">发票退回</a></li>
									<li><a href="invoiceLost.html">发票作废及丢失</a></li>
									<li><a href="selectInvoice.html">发票查询</a></li>
								</ul>
							</div>
							<div class="table_mod" style="width:450px;">
								<div style="margin-top:10px;">
									<table class="table">
										...
										<tbody class="th_list">
											<tr class="odd">
												<td>发票号码： <input type="text" style="height:20px;" /></td>
												<td>退回人姓名姓名： <input type="text" style="height:20px;" /></td>
											</tr>
										</tbody>
									</table>
									<a style="padding-top:20px;margin-left:360px;"
										href="substationBillManage.html"><type =button id="add"
											class="btn_confirm">确定</a><br>
									<table class="table">
										发票退回
										<thead>
											<tr>
