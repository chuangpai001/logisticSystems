					...
					<form action="" method="post" id="addForm">
						<div class="add_mod" style="margin-top:20px;">
							...
							<div style="margin-top:10px;">
								...
								&nbsp;查询条件：<br>&nbsp;时&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;间1： <input
									onClick="laydate()"> 时间2： <input onClick="laydate()">
								商品种类： <select id="jia"
									onchange="ChangeExampleSelect(this.selectedIndex)"
									style="width:160px;">
								</select> &nbsp; 商品名称： <select id="example" style="width:160px;">
							...
							<div class="table_mod" style="width:450px;">
								...
								<div class="add_mod" style="margin-top:20px;">
									<div style="margin-top:10px;">
										...
										&nbsp;查询条件：<br> &nbsp;时&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;间1：
										<input onClick="laydate()"> 时间2： <input
											onClick="laydate()"> 配送员：<input type="text">
									...
									<div class="table_mod" style="width:450px;">
										...
										<div style="margin-top:10px;">
											&nbsp;&nbsp;共有10条记录，当前第1/10页
											<table style="margin-top:-20px;margin-left:660px;">
												<tbody>
													<tr>
														<td>
															&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
															<button>首页</button>&nbsp;
															<button>上一页</button>&nbsp;
															<button>下一页</button> <span> 跳转到第 <input
																style="width:30px;"> 页
														</span> <input type="submit" value="跳转">
														</td>
													</tr>
												</tbody>
											</table>
