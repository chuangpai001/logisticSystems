					...
					<form action="" method="post" id="addForm">
						<div class="add_mod" style="margin-top:20px;">
							...
							<div style="margin-top:10px;">
								&nbsp;查询条件：<br>&nbsp;请选择时间： <input onClick="laydate()">
								任务类型： <select style="width:150px;">
									<option>送货</option>
									<option>退货</option>
									<option>换货</option>
								</select> 投递员：<input type="text"> <input type="submit" value="查询">
							</div>
									...
									<table class="table">
										...
										<tbody class="th_list">
											<tr class="odd">
												...
												<td>2017-07-15</td>
												<td>送货</td>
												<td><a href="returnReceiptEntryResult.html"
											...
											<tr class="odd">
												...
												<td>2017-07-15</td>
												<td>退货</td>
												<td><a href="returnReceiptEntryResult2.html"
													style="color:#000000">录入</a></td>
											</tr>
											<tr class="odd">
												<td height="30px">3</td>
												...
												<td>2017-07-15</td>
												<td>换货</td>
												<td><a href="returnReceiptEntryResult3.html"
													style="color:#000000">录入</a></td>
											</tr>
										</tbody>
									</table>
