					...
					<form action="" method="post" id="addForm">
						<div class="add_mod" style="margin-top:20px;">
							...
							<div style="margin-top:10px;">
								&nbsp;查询条件：&nbsp;请选择时间： <input onClick="laydate()">
								任务状态： <select style="width:180px;">
									<option>可分配</option>
									<option>可调度</option>
									<option>已调度</option>
									<option>已分配</option>
									...
									onclick="window.location.href='http://localhost:8080/logisticSystem/html/substation/taskAllocation.html'"
									value="查询">
							</div>
							...
							<div>
								<a style="padding-top:20px;margin-left:350px;"
									href="taskAllocation.html"><type =button id="add"
										class="btn_confirm">返回</a>
