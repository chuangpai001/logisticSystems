					...
					<form action="" method="post" id="addForm">
						<div class="add_mod" style="margin-top:20px;">
							...
							<div style="margin-top:10px;">
								&nbsp;查询条件：<br>&nbsp;时&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;间1： <input
									onClick="laydate()"> &nbsp;时间2： <input
									onClick="laydate()"> 任务状态： <select style="width:180px;">
									<option>可分配</option>
									<option>可调度</option>
									<option>已调度</option>
									<option>已分配</option>
									...
									onclick="window.location.href='http://localhost:8080/logisticSystem/html/substation/taskAllocationResult.html'"
									value="查询">
							</div>
							...
							<div>
								<a style="padding-top:20px;margin-left:350px;"
									href="sendTaskToDeliveryMan.html"><type =button id="add"
